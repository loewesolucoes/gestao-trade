...
export default function Home() {
  ...
  async function toogleMark(markedStocks: { [key: string]: Stock; }) {
    ...
    try {
      ...
      const rawResponse = await fetch(`https://localhost:7062/stock/toggle_stock_active`, {
        method: 'POST',
  ...
  return (
    <section className="container">
      ...
      <div className="cards">
        {stocks.map(s => (
          <StockCard key={s.code} stock={s} isActive={!!markedStocks[s.code]} onClick={MarkStock} />
        ))}
      </div>
